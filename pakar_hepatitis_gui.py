...
# Inisialisasi prolog
prolog = Prolog()
prolog.consult("pakar_hepatitis_gui.pl")
...
def hasil_diagnosa(penyakit = ""):
    if penyakit:
        ...
        messagebox.showinfo("Hasil Diagnosa", f"Tidak terdeteksi penyakit.")
...
root = tk.Tk()
root.title("Sistem Pakar Diagnosis Penyakit Hepatitis")
...
ttk.Label(mainframe, text="Aplikasi Diagnosa Penyakit Hepatitis", font=("Arial", 16)).grid(column=0, row=0, columnspan=3)
